$(document).ready(function () {
...

	{
		if ($(window).width() < 992) {
			...
			$(".dropdown-main__arrow").click(function (e) {
				e.preventDefault();
				$(this).parent().parent().siblings().removeClass("active");
				$(this).parent().parent().siblings().find(".dropdown-main__dropdown").slideUp(200);
				if ($(this).parent().parent().find(".dropdown-main__dropdown").is(":hidden")) {
					$(this).parent().parent().find(".dropdown-main__dropdown").slideDown(200);
					$(this).parent().parent().addClass("active");
				} else {
					$(this).parent().parent().find(".dropdown-main__dropdown").slideUp(200);
